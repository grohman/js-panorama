...
a?c.goToNext():c.goToPrevious()},c.opts.animationDuration)};this.goToNext=function(){this.changeItem(!0)};this.goToPrevious=function(){this.changeItem(!1)};this.setEvents=function(a){function c(g){if(!("mousemove"==g.type&&0==b.NumberOfKeys(b.opts.eventsSettings.lastXYById)))for(var f=g.changedTouches?g.changedTouches:[g],j=0;j<f.length;++j){var l=f[j],h="undefined"!=typeof l.identifier?l.identifier:"undefined"!=typeof l.pointerId?l.pointerId:1;b.EnsurePageXY(l);var k=l.pageX,l=l.pageY;if(g.type.match(/(start|down)$/i))documentToTargetDelta=
b.ComputeDocumentToElementDelta(a),b.opts.eventsSettings.lastXYById[h]&&(delete b.opts.eventsSettings.lastXYById[h],b.opts.debug&&d("<div>").html("end").prependTo(b.opts.debug)),b.opts.debug&&d("<div>").html("start at "+k+"px").prependTo(b.opts.debug),b.opts.eventsSettings.lastXYById[h]={x:k,y:l},m=k,a.msSetPointerCapture?a.msSetPointerCapture(h):"mousedown"==g.type&&1==b.NumberOfKeys(b.opts.eventsSettings.lastXYById)&&(b.opts.eventsSettings.useSetReleaseCapture?a.setCapture(!0):(document.addEventListener("mousemove",
c,!1),document.addEventListener("mouseup",c,!1)));else if(g.type.match(/move$/i))void 0!==b.opts.eventsSettings.lastXYById[h]&&(b.opts.eventsSettings.lastXYById[h].x=k,b.opts.eventsSettings.lastXYById[h].y=l,e=k-m,h=20,Math.abs(e)>h?(0>e&&(h=-h),h=e-h,b.opts.debug&&d("<div>").html("move: "+h+"px").prependTo(b.opts.debug),b.getItemsContainer().css("left",h+"px")):e=0);else if(b.opts.eventsSettings.lastXYById[h]&&g.type.match(/(up|end|cancel)$/i)){b.opts.debug&&d("<div>").html("end").prependTo(b.opts.debug);
var n=setInterval(function(){!1==b.opts.busy&&clearInterval(n);0<e?b.goToPrevious():0>e&&b.goToNext();e=0},10);delete b.opts.eventsSettings.lastXYById[h];a.msReleasePointerCapture?a.msReleasePointerCapture(h):"mouseup"==g.type&&0==b.NumberOfKeys(b.opts.eventsSettings.lastXYById)&&(0<e&&(g.preventDefault&&g.preventDefault(),g.preventManipulation&&g.preventManipulation(),g.preventMouseEvent&&g.preventMouseEvent()),b.opts.eventsSettings.useSetReleaseCapture?a.releaseCapture():(document.removeEventListener("mousemove",
c,!1),document.removeEventListener("mouseup",c,!1)))}}}var b=this;if(window.navigator.msPointerEnabled)a.addEventListener("MSPointerDown",c,!1),a.addEventListener("MSPointerMove",c,!1),a.addEventListener("MSPointerUp",c,!1),a.addEventListener("MSPointerCancel",c,!1),"undefined"!=typeof a.style.msContentZooming&&(a.style.msContentZooming="none"),"undefined"!=typeof a.style.msTouchAction&&(a.style.msTouchAction="none"),b.opts.debug&&d("<div>").html("Using Microsoft pointer model").prependTo(b.opts.debug);
else if(a.addEventListener)a.addEventListener("touchstart",c,!1),a.addEventListener("touchmove",c,!1),a.addEventListener("touchend",c,!1),a.addEventListener("touchcancel",c,!1),a.addEventListener("mousedown",c,!1),a.setCapture&&!window.navigator.userAgent.match(/\bGecko\b/)&&(this.opts.eventsSettings.useSetReleaseCapture=!0,a.addEventListener("mousemove",c,!1),a.addEventListener("mouseup",c,!1)),b.opts.debug&&d("<div>").html("Using mouse model with capture").prependTo(b.opts.debug);else if(a.attachEvent&&
...
1);var f=this.getItem(b),g=2<this.totalNumberOfItems?this.getItem(c):void 0,j,k;!a&&f&&(f.css({left:-this.opts._item_width+this.opts.itemsLeftMarginPercent}),3<this.totalNumberOfItems&&(j=this.fixIndex(b-1),k=this.getItem(j),this.getItems().not(":eq("+this.opts.currentIndex+")").not(":eq("+b+")").not(":eq("+j+")").hide(),this.getItem(this.fixIndex(b-1)).css({left:-this.opts._item_width+this.opts.itemsLeftMarginPercent})));a&&g&&(g.css({left:2*this.opts._item_width+this.opts.itemsLeftMarginPercent}),
this.getItems().not(":eq("+this.opts.currentIndex+")").not(":eq("+c+")").hide());a={left:(a?"-=":"+=")+this.opts._item_width};f&&f.show();g&&g.show();var l=this;f&&f.animate(a,this.opts.animationDuration,this.opts.animationEasing,function(){l.opts.currentIndex=b;l.opts.busy=!1;k&&k.show();l.$el.trigger(l.opts.selectedItemChangedEventName)});g&&g.animate(a,this.opts.animationDuration,this.opts.animationEasing);e.animate(a,this.opts.animationDuration,this.opts.animationEasing);this.getItemsContainer().animate({left:"0px"},
...
1,j=this.getItemsContainer().position().top,a=f-j;e.height(a);this.getItemsContainer().height(a);this.totalNumberOfItems=this.getItems().length;var c=e.outerWidth()*(100-this.opts.itemsGapPercentage)/100;this.opts._item_width=c;e=Math.round(d(window).width()/100*this.opts.itemsLeftMarginPercent);this.opts.itemsLeftMarginPercent=e;this.getItems().each(function(b,e){d(e).height(a-(d(e).outerHeight()-d(e).height()));d(e).width(c-(d(e).outerWidth()-d(e).width()));1==b&&d(e).css({left:c});1<b&&d(e).hide()});
2<this.opts.totalNumberOfItems&&(this.getLastItem().css({left:"-"+c+"px"}).show(),this.getItems().css("left","+="+e+"px"))},show:function(){var e=this;this.getItemsContainer().fadeIn(function(){var f=e.getItemsContainer().position().top;e.getItems().each(function(){d(this).css("height","-="+f+"px")})})}};d.fn.panorama=function(e){this.length&&this.each(function(){var f=new k(this,e);f.init()&&(f.setEvents(this),f.show(),d(this).data("panorama",f))})}})(jQuery);
$.easing.easeOutExpo=function(d,k,e,f,j){return k==j?e+f:f*(-Math.pow(2,-10*k/j)+1)+e};