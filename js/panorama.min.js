...
a.opts.clickedWrapperClass).hide();c(document.elementFromPoint(f,q)).addClass(a.opts.clickedElementClass);c("."+a.opts.clickedWrapperClass).show()}else if(h.type.match(/move$/i))void 0!==a.opts.eventsSettings.lastXYById[n]&&(a.opts.eventsSettings.lastXYById[n].x=f,a.opts.eventsSettings.lastXYById[n].y=q,l=f-g,m=j-q,n=30,30<Math.abs(m)?(0<m&&"up"!=a.opts.eventsSettings.yDirection?(m-=30,a.opts.eventsSettings.yDirection="down"):(m+=30,a.opts.eventsSettings.yDirection="up"),!1==a.opts.busy&&(m+=a.getItem(a.opts.currentIndex).scrollTop(),
j+=a.getItem(a.opts.currentIndex).scrollTop()),a.opts.busy=!0,a.getItem(a.opts.currentIndex).scrollTop(m),a.opts.eventsSettings.moved=m,a.opts.debug&&c("<div>").html("going "+a.opts.eventsSettings.yDirection+": "+m).prependTo(a.opts.debug),l=0):Math.abs(l)>n?(0>l&&(n=-n),a.opts.eventsSettings.moved=l-n,a.opts.debug&&c("<div>").html("move: "+a.opts.eventsSettings.moved+"px").prependTo(a.opts.debug),!1==a.opts.busy&&a.getItemsContainer().css({left:a.opts.eventsSettings.moved+"px"})):(m=l=0,a.opts.eventsSettings.moved=
0));else if(a.opts.eventsSettings.lastXYById[n]&&h.type.match(/(up|end|cancel)$/i)){delete a.opts.eventsSettings.lastXYById[n];b.msReleasePointerCapture?b.msReleasePointerCapture(n):"mouseup"==h.type&&0==e(a.opts.eventsSettings.lastXYById)&&(a.opts.eventsSettings.useSetReleaseCapture?b.releaseCapture():(document.removeEventListener("mousemove",d,!1),document.removeEventListener("mouseup",d,!1)));a.opts.debug&&c("<div>").html("end").prependTo(a.opts.debug);null!=a.opts.eventsSettings.yDirection&&(a.opts.eventsSettings.yDirection=
null,a.opts.busy=!1);var u=setInterval(function(){!1==a.opts.busy&&(clearInterval(u),0<l?(a.goToPrevious(),l=0):0>l&&(a.goToNext(),l=0))},10);setTimeout(function(){c("."+a.opts.clickedElementClass).each(function(){c(this).removeClass(a.opts.clickedElementClass);(0==a.opts.eventsSettings.moved||void 0===a.opts.eventsSettings.moved)&&c(this).click()});null==a.opts.eventsSettings.yDirection&&(a.opts.eventsSettings.moved=0)},100)}}}}var a=this;if(window.navigator.msPointerEnabled)b.addEventListener("MSPointerDown",
d,!1),b.addEventListener("MSPointerMove",d,!1),b.addEventListener("MSPointerUp",d,!1),b.addEventListener("MSPointerCancel",d,!1),"undefined"!=typeof b.style.msContentZooming&&(b.style.msContentZooming="none"),"undefined"!=typeof b.style.msTouchAction&&(b.style.msTouchAction="none"),a.opts.debug&&c("<div>").html("Using Microsoft pointer model").prependTo(a.opts.debug);else if(b.addEventListener)b.addEventListener("touchstart",d,!1),b.addEventListener("touchmove",d,!1),b.addEventListener("touchend",
d,!1),b.addEventListener("touchcancel",d,!1),b.addEventListener("mousedown",d,!1),b.setCapture&&!window.navigator.userAgent.match(/\bGecko\b/)&&(this.opts.eventsSettings.useSetReleaseCapture=!0,b.addEventListener("mousemove",d,!1),b.addEventListener("mouseup",d,!1)),a.opts.debug&&c("<div>").html("Using mouse model with capture").prependTo(a.opts.debug);else if(b.attachEvent&&b.setCapture)a.opts.eventsSettings.useSetReleaseCapture=!0,b.attachEvent("onmousedown",function(){d(window.event);return window.event.returnValue=
