...
"%"},this.opts.animationDuration,this.opts.animationEasing);return!0}}l.prototype={init:function(){var c=this.$el;if(c.data("panorama"))return!1;c.attr("data-panorama",!0);this.prepare(c);return!0},prepare:function(f){var e=f.parent().height();f.height(e);var j=this.getItemsContainer().position().top,a=e-j;this.getItemsContainer().height(a);this.totalNumberOfItems=this.getItems().length;var d=f.outerWidth()*(100-this.opts.itemsGapPercentage)/100;this.opts._item_width=d;f=Math.round(c(window).width()/
